...
?>
<div class="item cab_contact active">

<div class="tit"><?=GetMessage("REG_SHOW_HIDE")?></div>
<div class="node">
...
<div class="tit"><?=GetMessage("USER_PERSONAL_INFO")?></div>
<div class="node">
...
<div class="tit"><?=GetMessage("USER_WORK_INFO")?></div>
<div class="node">
...
?>
<div class="item">
<div class="tit"><?=GetMessage("forum_INFO")?></div>
<div class="node">
...
?>
<div class="item">
<div class="tit"><?=GetMessage("blog_INFO")?></div>
<div class="node">
...
?>
	...
	<div class="item">
	<div class="tit"><?=GetMessage("learning_INFO")?></div>
	<div class="node">
...
?>
	...
	<div class="item">
	<div class="tit"><?=GetMessage("USER_ADMIN_NOTES")?></div>
	<div class="node">
	...
	<div class="item">
	<div class="tit"><?=strlen(trim($arParams["USER_PROPERTY_NAME"])) > 0 ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB")?></div>
	<div class="node">
	...
	<p><input class="b-action" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input class="b-action" type="reset" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>

</section><!-- /cab_settings -->
<?/*
