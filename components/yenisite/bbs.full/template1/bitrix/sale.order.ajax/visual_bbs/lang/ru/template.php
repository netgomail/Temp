...
$MESS ['SOA_TEMPL_ORDER_SUC1'] = "Вы можете управлять своими объявлениями в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
...
$MESS ['SOA_TEMPL_ORDER_PAYED'] = "Объявление успешно оплачено";
...
$MESS["BBS_NOT_ENOUGH_MONEY"] = "Недостаточно средств на внутреннем счете для оплаты заказа. Пожалуйста пополните внутренний счет в ";
$MESS["BBS_PERSONAL"] = "личном кабинете";
